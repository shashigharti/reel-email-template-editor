...
<table width="100%" bgcolor="#F0F0F0" role="presentation">
  <tr>
    <td align="center">
      ...
      <table class="container" bgcolor="#FFFFFF" width="660" style="max-width:660px; border-radius: 8px; overflow: hidden;" align="center">
        <tr>
          <td width="100%" height="200" cellpadding="0" cellspacing="0" border="0"
              background="https://reel-reel.com/wp-content/uploads/2016/09/1-1200x480.jpg"
              style="background-image: url('https://reel-reel.com/wp-content/uploads/2016/09/1-1200x480.jpg'); background-size: cover; background-position: center;">
              
            <table role="presentation" width="100%" height="200" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" valign="middle" style="background-color: rgba(219, 204, 204, 0.4);">
      ...
      <!-- FOOTER -->
      <table class="wrapper" width="660" style="max-width: 660px;" align="center">
        <tr>
          <td align="center" style="color: #7B1F1F; font-size: 13px;">
            <table class="wrapper" width="660" style="max-width: 660px;" align="center">
              <tr>
